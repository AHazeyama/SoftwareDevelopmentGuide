...
[🗋 要件定義](https://github.com/AHazeyama/SoftwareDevelopmentGuide/blob/main/docs/01_RequirementDefinition.md)  
## 基本設計  
システム全体の構成や画面、データ構造、機能の関連性を整理する工程。  
実装前にシステム全体の設計方針を明確にし、開発・保守しやすい構成を目指します。  
[🗋 基本設計](https://github.com/AHazeyama/SoftwareDevelopmentGuide/blob/main/docs/02_BasicDesign.md)  
## 詳細設計 (コーディング規約)  
...
　　　　[🗋 C# / WPF](https://github.com/AHazeyama/SoftwareDevelopmentGuide/blob/main/templates/exrm_WPF_VS2026.md)  
　　　Terminal & Editor による開発用テンプレートです。  
　　　　[🗋 Python / PySide6](https://github.com/AHazeyama/SoftwareDevelopmentGuide/blob/main/templates/renm_ps6_Vim.md)  
### 　Mobile  
　　　AndroidStudioによるAPK開発用テンプレートです。  
　　　　[🗋 Dart / Flutter](https://github.com/AHazeyama/public/blob/main/tmct_flt/tmct_flt_AndroidStudio.md)  
## Git運用  
