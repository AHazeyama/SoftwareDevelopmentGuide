...
|:--|:--|
|OS|Windows11|
|IDE|VisualStudio Community 2026|
|言語|C#|
|Framework|WPF|
...
　　</PropertyGroup>  
```
🔷 単一exe化（Single File Publish）<br>
　　「公開」「現在公開している場所」「ターゲット」<br>
　　　「🗀 フォルダー」🖲️⬇️ ⇒ [次へ(N)]🖲️⬇️<br>
　　「公開」「どのローカルターゲットに発行しますか」「特定のターゲット」<br>
　　　「🗀 フォルダー」🖲️⬇️ ⇒ [次へ(N)]🖲️⬇️<br>
　　「公開」「ローカルまたはネットワークフォルダーへのパスを指定してください」「場所」<br>
　　　「フォルダーの場所」👈指定 ⇒ [参照'(R)…]🖲️⬇️ ⇒ [完了(F)]🖲️⬇️ <br>
　　「実行プロファイル作成の進行状況」[完了]<br>
　　　[閉じる]🖲️⬇️<br>

　[発行]️ ⬇️：👈exeが作成される(言葉が解りにくい😾)  
🔷 公開結果 ⇒ 🪰デバッグ(勝手にやって😎)  
　📦 出力先  
　　　C:\Users\atsus\bin\repos\VisualStudio\exrm_wpf\bin\Release\net10.0-windows\win-x64\publish  
　　単体起動exeは"publish"に出力される。  
　　⚠️win-x64以下のexeは.dllが必要(️単体ではない)。  
